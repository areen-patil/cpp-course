...
// int date_compare(const std::string& date1, const std::string& date2) {
...
public:
    ...
    // vector <Conventions> conventions;
    ...
    // map <string, vector <string>> mp;
    // vector <string> v={"Track and Field"};
    // mp["Indoor Games"];
    // const string s="Indoor Stadium";
